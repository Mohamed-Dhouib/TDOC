...
from ..backbones.nat import NATLayer

import natten
# keep references to the real kernels
real_qkrpb = natten._C.natten2dqkrpb_forward
real_dav = natten._C.natten2dav_forward

@torch._dynamo.disable
def _natten2dqkrpb_disabled(*args, **kwargs):
    return real_qkrpb(*args, **kwargs)

@torch._dynamo.disable
def _natten2dav_disabled(*args, **kwargs):
    return real_dav(*args, **kwargs)

# overwrite the functions on natten._C
natten._C.natten2dqkrpb_forward = _natten2dqkrpb_disabled
natten._C.natten2dav_forward = _natten2dav_disabled
