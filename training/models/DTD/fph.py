...
global_params = GlobalParams(width_coefficient=1.8, depth_coefficient=2.6, image_size=1536, dropout_rate=0.0, num_classes=1000, batch_norm_momentum=0.99, batch_norm_epsilon=0.001, drop_connect_rate=0.0, depth_divisor=8, min_depth=None, include_top=True)
...
class MBConvBlock(nn.Module):
    def __init__(self, block_args, global_params):
        ...
        self._depthwise_conv = nn.Conv2d(
            ...
            kernel_size=k, stride=s, padding=pad, bias=False)
